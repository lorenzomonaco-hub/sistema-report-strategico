...
export type RigaErog = {
  ...
  dataFattura?: string // data fattura (ISO) dal file "Report in lavorazione" — usata come data vendita
  prezzo?: number      // importo in fattura (€) dal file "Report in lavorazione"
}
...
export const RISPARMIO_SECONDO = RISPARMIO_ANNUO / (365 * 24 * 60 * 60)
...
export const EROG_CLIENTI: RigaErog[] = [
  ...
  { nome: 'Agostino Romano', azienda: 'Romano SPA', tutor: 'Anissia Cabiddu', servizio: '2 piani mktg', stadio: 1, dataFattura: '2026-03-23', prezzo: 19987 },
  { nome: 'Alessandro Chirico', azienda: 'Alessandro Chirico', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-11-28', prezzo: 9000 },
  { nome: 'Alessandro Fazio', azienda: 'Fazio SRL', tutor: 'Sabrina Piazzolla', servizio: 'Startup', stadio: 1, dataFattura: '2026-01-23', prezzo: 11487 },
  { nome: 'Alessandro Fazio', azienda: 'Nexora SRL', tutor: 'Sabrina Piazzolla', servizio: 'Piano Mktg', stadio: 1, dataFattura: '2026-06-26', prezzo: 25000 },
  { nome: 'Alessandro Fazio', azienda: 'Nexora SRL', tutor: 'Sabrina Piazzolla', servizio: 'Brand', stadio: 1, dataFattura: '2026-06-26', prezzo: 25000 },
  { nome: 'Andrea Dallan', azienda: 'Dallan SPA', tutor: 'Anissia Cabiddu', servizio: 'Marbella', stadio: 1, dataFattura: '2022-11-30', prezzo: 14689.5 },
  { nome: 'Andrea Malgaroli', azienda: 'Ciski Malgaroli Andrea', tutor: 'Anissia Cabiddu', servizio: 'Brand', stadio: 1, dataFattura: '2026-02-06', prezzo: 0.01 },
  { nome: 'Andrea Poggi', azienda: 'Fastlan SRL', tutor: 'Cristian Frigerio', servizio: 'Strategica', stadio: 1, dataFattura: '2026-05-13', prezzo: 15000 },
  { nome: 'Antonio Cannata', azienda: 'Red Raion SRL', tutor: 'Silvia Andreani', servizio: 'Smart', stadio: 1, dataFattura: '2026-07-02', prezzo: 6000 },
  { nome: 'Antonio Chillocci', azienda: "L'Artigiano Group SRL", tutor: 'Elsa Galeotti', servizio: 'Strategica', stadio: 1, dataFattura: '2026-03-30', prezzo: 13000 },
  { nome: "Antonio Franzè", azienda: "Antonio Franzè", tutor: 'Cristian Frigerio', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-22', prezzo: 2500 },
  { nome: 'Bruno Stomeo', azienda: 'Bakery & Bakpow SRL', tutor: 'Elsa Galeotti', servizio: 'Strat+Brand', stadio: 1, dataFattura: '2026-05-29', prezzo: 26000 },
  { nome: 'Christian Valentini', azienda: 'Dinamica Pulizie', tutor: 'Cristian Frigerio', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-30', prezzo: 5000 },
  { nome: 'Claudio De Padua', azienda: 'Clamore SSD A RL', tutor: 'Matteo Novati', servizio: 'Piano Mktg', stadio: 1, dataFattura: '2025-12-16', prezzo: 0 },
  { nome: 'Davide Garofalo', azienda: 'Davide Garofalo', tutor: 'Silvia Andreani', servizio: 'Startup', stadio: 1, dataFattura: '2025-09-11', prezzo: 0 },
  { nome: 'Diego Radenza', azienda: 'Tegi SRL', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-09', prezzo: 2500 },
  { nome: 'Emiliano Peviani', azienda: 'Cercar SRL', tutor: 'Anissia Cabiddu', servizio: 'Strategica', stadio: 1, dataFattura: '2026-03-18', prezzo: 17487 },
  { nome: 'Ernesto Iuliano', azienda: 'Almer SRL', tutor: 'Thomas Farinelli', servizio: 'Strategica', stadio: 1, dataFattura: '2025-10-30', prezzo: 10000 },
  { nome: 'Ethel Cogliani', azienda: 'Ethel Cogliani', tutor: 'Andrea Busellu', servizio: 'Smart', stadio: 1, dataFattura: '2026-06-19', prezzo: 6000 },
  { nome: 'Fabrizio Ascoli', azienda: 'Fabrizio Ascoli', tutor: 'Fabio Vecchiato', servizio: 'Strategica', stadio: 1, dataFattura: '2025-09-30', prezzo: 9987 },
  { nome: 'Federico Montagna', azienda: 'Fede & Vale SRL', tutor: 'Silvia Andreani', servizio: 'Piano Mktg', stadio: 1, dataFattura: '2025-01-31', prezzo: 11981 },
  { nome: 'Francesco Ciaccia', azienda: 'Zoneriflesse Company SRL', tutor: 'Fabio Vecchiato', servizio: 'Consulenza Online', stadio: 1, dataFattura: '2026-07-07', prezzo: 5000 },
  { nome: 'Franco Tocci', azienda: 'Ambrogio SRL', tutor: 'Cristian Frigerio', servizio: 'Strategica', stadio: 1, dataFattura: '2025-08-21', prezzo: 5000 },
  { nome: 'Gerardo Muto', azienda: 'Autocentro F.lli Muto SRL', tutor: 'Sabrina Piazzolla', servizio: 'Piano Mktg', stadio: 1, dataFattura: '2025-10-10', prezzo: 19987 },
  { nome: 'Giacomo Roncarati', azienda: 'Tef SRL', tutor: 'Silvia Andreani', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-18', prezzo: 9987 },
  { nome: 'Gigi Marazzi', azienda: 'Marazzi Gian Luigi', tutor: 'Cristian Frigerio', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-16', prezzo: 2000 },
  { nome: 'Giovanni Corsini', azienda: "Caffè Agust SRL", tutor: 'Thomas Farinelli', servizio: 'Strategica', stadio: 1, dataFattura: '2025-08-29', prezzo: 5000 },
  { nome: 'Giovanni F. Maugeri', azienda: 'GFM SRLS', tutor: 'Fabio Vecchiato', servizio: 'Strategica', stadio: 1, dataFattura: '2026-04-30', prezzo: 12000 },
  { nome: 'Giovanni Pane', azienda: 'Studio Dentistico Pane STP SRL', tutor: 'Cristian Frigerio', servizio: 'Strategica', stadio: 1, dataFattura: '2026-07-07', prezzo: 13000 },
  { nome: 'Giulia Favero', azienda: 'Officine Alpi SRL', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-14', prezzo: 2500 },
  { nome: 'Ivan Righetti', azienda: 'Righetti Ivan Car Service', tutor: 'Leonardo Mazzon', servizio: 'Strategica', stadio: 1, dataFattura: '2026-01-16', prezzo: 10000 },
  { nome: 'Ivano Salina', azienda: 'Lubes SRL', tutor: 'Fabio Vecchiato', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-22', prezzo: 8000 },
  { nome: 'Jacopo Pisati', azienda: 'Studio Associato Morassi Pisati', tutor: 'Anissia Cabiddu', servizio: 'Strategica', stadio: 1, dataFattura: '2026-03-10', prezzo: 11315 },
  { nome: 'Kemuel Paradiso', azienda: 'Termozero SRL', tutor: 'Sabrina Piazzolla', servizio: 'Strategica', stadio: 1, dataFattura: '2026-01-15', prezzo: 9000 },
  { nome: 'Kevin Nucera', azienda: 'Kevin Nucera', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-09', prezzo: 2500 },
  { nome: 'Lorenzo Romano', azienda: 'Lorenzo Romano', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-08-20', prezzo: 5000 },
  { nome: 'Lorenzo Romano', azienda: '3 Soldi SRL', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2026-04-13', prezzo: 16987 },
  { nome: 'Loris Cadiri', azienda: 'Homes4Holidays', tutor: 'Thomas Farinelli', servizio: 'Strategica', stadio: 1, dataFattura: '2025-12-30', prezzo: 10000 },
  { nome: 'Luca Sgherri', azienda: 'Luca Sgherri', tutor: 'Fabio Vecchiato', servizio: 'Strategica', stadio: 1, dataFattura: '2026-05-13', prezzo: 12000 },
  { nome: 'Luca Ungaretti', azienda: 'Studio Dentistico Ungaretti SRL', tutor: 'Cristian Frigerio', servizio: 'Startup', stadio: 1, dataFattura: '2025-11-06', prezzo: 487 },
  { nome: 'Marco Torresan', azienda: 'Wedqueen SRL', tutor: 'Fabio Vecchiato', servizio: 'Strategica', stadio: 1, dataFattura: '2025-12-19', prezzo: 10000 },
  { nome: 'Martinelli Mara', azienda: 'European Textile', tutor: 'Elsa Galeotti', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-24', prezzo: 1000 },
  { nome: 'Matteo Gatti', azienda: 'C.G.R. Targhe e Timbri SRL', tutor: 'Sabrina Piazzolla', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-29', prezzo: 7103 },
  { nome: 'Nicola Ornelli', azienda: 'Bruciaferro SRL', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-11', prezzo: 2500 },
  { nome: 'Ornella Auzino', azienda: 'Rica SRL Unipersonale', tutor: 'Silvia Andreani', servizio: 'Strategica', stadio: 1, dataFattura: '2023-12-15', prezzo: 14559 },
  { nome: 'Paola Canegrati', azienda: 'Studio Dentistico Signorelli SRL', tutor: 'Cristian Frigerio', servizio: '+Upsell', stadio: 1, dataFattura: '2025-10-31', prezzo: 12709 },
  { nome: 'Piergiorgio Carlini', azienda: 'Associazione Unisardegna', tutor: 'Fabio Vecchiato', servizio: 'Smart', stadio: 1, dataFattura: '2025-12-19', prezzo: 693 },
  { nome: "Roberto D'Ancona", azienda: 'Ecoenergie SRL', tutor: 'Leonardo Mazzon', servizio: 'Strategica', stadio: 1 },
  { nome: 'Stefano Bertoli', azienda: 'Secit SRLS', tutor: 'Elsa Galeotti', servizio: 'Smart', stadio: 1, dataFattura: '2025-11-18', prezzo: 4000 },
  { nome: 'Steve Osler', azienda: 'Wildix SRL', tutor: 'Silvia Andreani', servizio: 'Strategica', stadio: 1, dataFattura: '2026-03-06', prezzo: 2506.5 },
  { nome: 'Ugo Cuncu', azienda: 'Ucnet SRL', tutor: 'Matteo Novati', servizio: 'Strategica', stadio: 1, dataFattura: '2025-07-10', prezzo: 10000 },
  { nome: 'Vito Giudice', azienda: 'Giusta SRL', tutor: 'Silvia Andreani', servizio: 'Strategica', stadio: 1, dataFattura: '2025-08-21', prezzo: 5000 },
