...
// ─── Erogazione Copy — Board Kanban v2 (PRESERVATA) ───
// Vecchia board a 9 fasi (modello pipeline v2) agganciata allo store/blocco-dati
// e al Laboratorio. Conservata qui dopo la ristrutturazione di /erogazione sui
// silos reali del progetto Consulenze Frank. Contenuto invariato.
...
export default function PaginaBoardErogazioneV2() {
  ...
  return (
    <RoleShell
      ...
      sottotitolo="Board di produzione (v2) — trascina le card o aprile per lavorarci"
